...
from src.core.chatbot_v2 import ChatbotMarocVersion2
...
def creer_chatbot():
    ...
    # Créer le chatbot
    chatbot = ChatbotMarocVersion2(rag_index, gemini_key)
...
def test_question_unique():
    ...
    question = "Quel est le nombre total de diplômées féminines en 2021 ?"
    print(f"Question: {question}")
    print("-" * 40)
